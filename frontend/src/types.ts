...
export type AIConnectionTestRequest = ApiSchemas["AIConnectionTestRequest"];
export type AIConnectionTestResponse = ApiSchemas["AIConnectionTestResponse"];
...
export type JobActivityEvent = ApiSchemas["JobActivityEvent"];
export type JobActivitySnapshot = WithRequired<ApiSchemas["JobActivitySnapshot"], "events">;
