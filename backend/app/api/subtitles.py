    ...
    *,
    ...
    def create_transcript_correction_endpoint(
        ...
        config = build_note_generation_config(
            ...
            note_thinking_enabled=request.note_thinking_enabled,
            note_context_window_tokens=request.note_context_window_tokens,
            note_max_output_tokens=request.note_max_output_tokens,
