...
def snapshot_root_note_as_manual_version(job_dir: Path) -> NoteVersionIndex:
    ...
    version = NoteVersion(
        ...
        note_api_protocol=str(metadata.get("note_api_protocol") or "openai_chat_completions"),
        note_thinking_enabled=bool(metadata.get("note_thinking_enabled") or False),
        note_context_window_tokens=int(metadata.get("note_context_window_tokens") or 32_768),
        note_max_output_tokens=int(metadata.get("note_max_output_tokens") or 8_192),
...
def create_note_version_from_draft(
    *,
    ...
    version = NoteVersion(
        ...
        note_api_protocol=config.note_api_protocol,
